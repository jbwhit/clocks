...
pairs are sorted together so $x_1 < x_2$. During
...
In the demonstrated run, the filter separates them: five clocks each
contribute a small disagreement, and 80 noisy observations compound those
disagreements. No single reading is decisive, and none has to be.
